...
\node (train1) [right=of train] {EB Set 5\%};
\node (train2) [below=.5cm of train1] {Training Set 95\%};

\node (priors) [right=of train1] {Priors, \\2/class};
...
<!-- ```{r workflow, engine='tikz'} -->
<!-- %{tikzpicture, node distance = 1cm, auto, every node/.style={draw, thick, rounded corners}, -->
<!-- % Define nodes for the flowchart -->
<!-- \begin{tikzpicture} -->
<!-- \node (train) at (0,0) {Train Data \ 60,000 \ 28x28}; -->
<!-- \node (labels) [below=0.5cm of train] {Digits \ 0-9}; -->
<!-- \node (reshape) [right=2cm of train] {Reshape \ D \ 60000x784}; -->
<!-- \node (proj) [right=2cm of reshape] {Project to \ k-dim}; -->
<!-- \node (mu1) [below=0.5cm of proj] {mu_1}; -->
<!-- \node (mu2) [below=0.2cm of mu1] {mu_2}; -->
<!-- \node (muk) [below=0.2cm of mu2] {mu_k}; -->
<!-- \node (uniform) [below=0.5cm of muk] {Uniform}; -->
<!-- \node (posterior) [right=2cm of proj] {Posterior \ Probability}; -->
<!-- \node (test) [below=3cm of train] {Test Data \ 10,000 \ 28x28}; -->
<!-- \node (reshape_test) [right=2cm of test] {Reshape \ q \ 10000x784}; -->
<!-- \node (proj_test) [right=2cm of reshape_test] {Project to \ k-dim}; -->
<!-- \node (classify) [right=2cm of posterior] {Classify by min. distance}; -->
<!-- \node (test_pp) [below=0.5cm of classify] {test pp}; -->
<!-- \node (eval) [right=2cm of classify] {$\\begin{pmatrix} ? & 1 & 2 \\ 1 & 0 & 1 \\ 2 & 1 & ? \\end{pmatrix}$}; -->
...
<!-- \draw [->] (mu2) -- (posterior); -->
<!-- \draw [->] (muk) -- (posterior); -->
<!-- \draw [->] (uniform) -- (posterior); -->
<!-- \draw [->] (test) -- (reshape_test); -->
<!-- \draw [->] (reshape_test) -- (proj_test); -->
<!-- \draw [->] (proj_test) -- (classify); -->
<!-- \draw [->] (posterior) -- (classify); -->
<!-- \draw [->] (classify) -- (eval); -->
<!-- \draw [->] (test_pp) -| (eval); -->
<!-- \draw [->] (reshape) -- (reshape_test); -->
<!-- \draw [->, bend left] (posterior) to node {EB} (proj); -->
