...
```{r pixel_intensity, fig.dim=c(6,3)}
#----------------------------------------------------------
...
<!-- Using t-distributed Stochastic Neighbor Embedding(t-SNE), we can represent the data in 2D.[^2] t-SNE is a technique for dimension reduction that is well-suited for visualizing high-dimensional data in a lower-dimensional space. -->
