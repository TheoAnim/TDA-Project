...
<!-- \textcolor{red}{We also consider the ability to do variable importance on predictors of a model.} -->
...
|-------------------------------|---------------------|-----------------------------|----------------------------   |--------------|
| **Multinomial**      | None                | –                           | None                          | 10 (Softmax) |
| **Dropout NN**                | 256, 128            | ReLU (hidden), Softmax (out)| Dropout (0.4, 0.3)            | 10 (Softmax) |
| **Ridge NN (L2)**             | 256, 128            | ReLU (hidden), Softmax (out)| L2 penalty $(\lambda = 0.01)$ | 10 (Softmax) |
| **Lasso NN (L1)**             | 256, 128            | ReLU (hidden), Softmax (out)| L1 penalty $(\lambda = 0.01)$ | 10 (Softmax) |
