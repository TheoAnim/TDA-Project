...
:::{.fragement}
- Depending on a mode, a network can have more weights than the size of training data. This leads to overfitting.
- We considered two approaches to overfitting
  - Dropout learning: think of RF, randomly remoces a fraction of the units in a layer during model fitting
